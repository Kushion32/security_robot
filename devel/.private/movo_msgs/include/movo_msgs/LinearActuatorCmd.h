...
bool operator==(const ::movo_msgs::LinearActuatorCmd_<ContainerAllocator1> & lhs, const ::movo_msgs::LinearActuatorCmd_<ContainerAllocator2> & rhs)
{
  return lhs.header == rhs.header &&
    lhs.desired_position_m == rhs.desired_position_m &&
    lhs.fdfwd_vel_mps == rhs.fdfwd_vel_mps;
}
