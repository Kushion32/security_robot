...
bool operator==(const ::movo_msgs::PanTiltActuatorFdbk_<ContainerAllocator1> & lhs, const ::movo_msgs::PanTiltActuatorFdbk_<ContainerAllocator2> & rhs)
{
  return lhs.header == rhs.header &&
    lhs.current == rhs.current &&
    lhs.pos_rad == rhs.pos_rad &&
    lhs.vel_rps == rhs.vel_rps &&
    lhs.torque_nm == rhs.torque_nm &&
    lhs.pwm == rhs.pwm &&
    lhs.encoder_rad == rhs.encoder_rad &&
    lhs.accel == rhs.accel &&
    lhs.temperature_degC == rhs.temperature_degC;
}
