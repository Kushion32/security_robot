...
"""autogenerated by genpy from movo_msgs/KinovaActuatorFdbk.msg. Do not edit."""
import codecs
import sys
...
class KinovaActuatorFdbk(genpy.Message):
  _md5sum = "e4c6d57595be8397a51a210a33d3ba9e"
  _type = "movo_msgs/KinovaActuatorFdbk"
...
string frame_id
"""
  __slots__ = ['header','current','temperature']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(KinovaActuatorFdbk, self).__init__(*args, **kwds)
