...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      pattern = '<%sI'%length
      buff.write(struct.Struct(pattern).pack(*self.wheel_motor_status))
      length = len(self.wheel_motor_current_A0pk)
      buff.write(_struct_I.pack(length))
      pattern = '<%sf'%length
      buff.write(struct.Struct(pattern).pack(*self.wheel_motor_current_A0pk))
      length = len(self.wheel_motor_speed_rps)
      buff.write(_struct_I.pack(length))
      pattern = '<%sf'%length
      buff.write(struct.Struct(pattern).pack(*self.wheel_motor_speed_rps))
      length = len(self.wheel_motor_position_rad)
      buff.write(_struct_I.pack(length))
      pattern = '<%sf'%length
      buff.write(struct.Struct(pattern).pack(*self.wheel_motor_position_rad))
      _x = self
      buff.write(_get_struct_I3f().pack(_x.linear_motor_status, _x.linear_motor_current_A0pk, _x.linear_motor_speed_rps, _x.linear_motor_position_rad))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      self.wheel_motor_status = s.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      pattern = '<%sf'%length
      ...
      self.wheel_motor_current_A0pk = s.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      pattern = '<%sf'%length
      ...
      self.wheel_motor_speed_rps = s.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      pattern = '<%sf'%length
      ...
      self.wheel_motor_position_rad = s.unpack(str[start:end])
      _x = self
      start = end
      end += 16
      (_x.linear_motor_status, _x.linear_motor_current_A0pk, _x.linear_motor_speed_rps, _x.linear_motor_position_rad,) = _get_struct_I3f().unpack(str[start:end])
      return self
