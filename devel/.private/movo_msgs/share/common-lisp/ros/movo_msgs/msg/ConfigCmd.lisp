...
(cl:defmethod cl:initialize-instance :after ((m <ConfigCmd>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'ConfigCmd)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name movo_msgs-msg:<ConfigCmd> is deprecated: use movo_msgs-msg:ConfigCmd instead.")))
...
(cl:defmethod gp_cmd-val ((m <ConfigCmd>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader movo_msgs-msg:gp_cmd-val is deprecated.  Use movo_msgs-msg:gp_cmd instead.")
  (gp_cmd m))

(cl:ensure-generic-function 'gp_param-val :lambda-list '(m))
(cl:defmethod gp_param-val ((m <ConfigCmd>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader movo_msgs-msg:gp_param-val is deprecated.  Use movo_msgs-msg:gp_param instead.")
  (gp_param m))
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<ConfigCmd>)))
  ...
  (cl:format cl:nil "Header header~%string gp_cmd~%uint32 gp_param~%~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%string frame_id~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'ConfigCmd)))
  "Returns full string definition for message of type 'ConfigCmd"
  (cl:format cl:nil "Header header~%string gp_cmd~%uint32 gp_param~%~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%string frame_id~%~%~%"))
