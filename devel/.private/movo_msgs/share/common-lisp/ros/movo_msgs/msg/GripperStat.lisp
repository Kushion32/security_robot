...
(cl:defmethod cl:initialize-instance :after ((m <GripperStat>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'GripperStat)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name movo_msgs-msg:<GripperStat> is deprecated: use movo_msgs-msg:GripperStat instead.")))
...
(cl:defmethod is_ready-val ((m <GripperStat>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader movo_msgs-msg:is_ready-val is deprecated.  Use movo_msgs-msg:is_ready instead.")
  (is_ready m))

(cl:ensure-generic-function 'is_reset-val :lambda-list '(m))
(cl:defmethod is_reset-val ((m <GripperStat>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader movo_msgs-msg:is_reset-val is deprecated.  Use movo_msgs-msg:is_reset instead.")
  (is_reset m))

(cl:ensure-generic-function 'is_moving-val :lambda-list '(m))
(cl:defmethod is_moving-val ((m <GripperStat>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader movo_msgs-msg:is_moving-val is deprecated.  Use movo_msgs-msg:is_moving instead.")
  (is_moving m))

(cl:ensure-generic-function 'obj_detected-val :lambda-list '(m))
(cl:defmethod obj_detected-val ((m <GripperStat>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader movo_msgs-msg:obj_detected-val is deprecated.  Use movo_msgs-msg:obj_detected instead.")
  (obj_detected m))

(cl:ensure-generic-function 'fault_status-val :lambda-list '(m))
(cl:defmethod fault_status-val ((m <GripperStat>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader movo_msgs-msg:fault_status-val is deprecated.  Use movo_msgs-msg:fault_status instead.")
  (fault_status m))

(cl:ensure-generic-function 'position-val :lambda-list '(m))
(cl:defmethod position-val ((m <GripperStat>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader movo_msgs-msg:position-val is deprecated.  Use movo_msgs-msg:position instead.")
  (position m))

(cl:ensure-generic-function 'requested_position-val :lambda-list '(m))
(cl:defmethod requested_position-val ((m <GripperStat>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader movo_msgs-msg:requested_position-val is deprecated.  Use movo_msgs-msg:requested_position instead.")
