...
(cl:defmethod cl:initialize-instance :after ((m <JacoCartesianVelocityCmd>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'JacoCartesianVelocityCmd)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name movo_msgs-msg:<JacoCartesianVelocityCmd> is deprecated: use movo_msgs-msg:JacoCartesianVelocityCmd instead.")))
...
(cl:defmethod x-val ((m <JacoCartesianVelocityCmd>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader movo_msgs-msg:x-val is deprecated.  Use movo_msgs-msg:x instead.")
  (x m))

(cl:ensure-generic-function 'y-val :lambda-list '(m))
(cl:defmethod y-val ((m <JacoCartesianVelocityCmd>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader movo_msgs-msg:y-val is deprecated.  Use movo_msgs-msg:y instead.")
  (y m))

(cl:ensure-generic-function 'z-val :lambda-list '(m))
(cl:defmethod z-val ((m <JacoCartesianVelocityCmd>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader movo_msgs-msg:z-val is deprecated.  Use movo_msgs-msg:z instead.")
  (z m))

(cl:ensure-generic-function 'theta_x-val :lambda-list '(m))
(cl:defmethod theta_x-val ((m <JacoCartesianVelocityCmd>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader movo_msgs-msg:theta_x-val is deprecated.  Use movo_msgs-msg:theta_x instead.")
  (theta_x m))

(cl:ensure-generic-function 'theta_y-val :lambda-list '(m))
(cl:defmethod theta_y-val ((m <JacoCartesianVelocityCmd>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader movo_msgs-msg:theta_y-val is deprecated.  Use movo_msgs-msg:theta_y instead.")
  (theta_y m))

(cl:ensure-generic-function 'theta_z-val :lambda-list '(m))
(cl:defmethod theta_z-val ((m <JacoCartesianVelocityCmd>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader movo_msgs-msg:theta_z-val is deprecated.  Use movo_msgs-msg:theta_z instead.")
  (theta_z m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<JacoCartesianVelocityCmd>)))
  ...
  "movo_msgs/JacoCartesianVelocityCmd")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'JacoCartesianVelocityCmd)))
  "Returns string type for a message object of type 'JacoCartesianVelocityCmd"
  "movo_msgs/JacoCartesianVelocityCmd")
