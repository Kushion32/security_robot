...
(cl:defmethod cl:initialize-instance :after ((m <JacoJointCmd>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'JacoJointCmd)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name movo_msgs-msg:<JacoJointCmd> is deprecated: use movo_msgs-msg:JacoJointCmd instead.")))
...
(cl:defmethod command_type-val ((m <JacoJointCmd>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader movo_msgs-msg:command_type-val is deprecated.  Use movo_msgs-msg:command_type instead.")
  (command_type m))

(cl:ensure-generic-function 'joint_cmds-val :lambda-list '(m))
(cl:defmethod joint_cmds-val ((m <JacoJointCmd>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader movo_msgs-msg:joint_cmds-val is deprecated.  Use movo_msgs-msg:joint_cmds instead.")
  (joint_cmds m))

(cl:ensure-generic-function 'vel_limits-val :lambda-list '(m))
(cl:defmethod vel_limits-val ((m <JacoJointCmd>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader movo_msgs-msg:vel_limits-val is deprecated.  Use movo_msgs-msg:vel_limits instead.")
  (vel_limits m))
