...
(cl:defmethod cl:initialize-instance :after ((m <JacoStatus>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'JacoStatus)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name movo_msgs-msg:<JacoStatus> is deprecated: use movo_msgs-msg:JacoStatus instead.")))
...
(cl:defmethod raw_joint_pos_rad-val ((m <JacoStatus>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader movo_msgs-msg:raw_joint_pos_rad-val is deprecated.  Use movo_msgs-msg:raw_joint_pos_rad instead.")
  (raw_joint_pos_rad m))
