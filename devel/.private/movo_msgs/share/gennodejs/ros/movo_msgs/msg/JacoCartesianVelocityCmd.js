...
class JacoCartesianVelocityCmd {
  constructor(initObj={}) {
    if (initObj === null) {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new JacoCartesianVelocityCmd(null);
  ...
  static datatype() {
    ...
    return 'movo_msgs/JacoCartesianVelocityCmd';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new JacoCartesianVelocityCmd(null);
...
module.exports = JacoCartesianVelocityCmd;
