const fs = require('fs');
const files = [
  'movo-nav-ui/src/WaypointDashboard.jsx',
  'movo-nav-ui/src/App.js',
  'movo-nav-ui/src/NavButton.jsx',
  'movo-nav-ui/src/RobotMap.jsx',
  'movo-nav-ui/src/VideoFeed.jsx',
  'movo-nav-ui/src/MapManager.jsx'
];
...
for (const file of files) {
  ...
  // Revert formatting artifacts like the space + trailing newline after exactly 80 chars
  // Actually, let's just do a specific regex for the broken words.
  ...
  // Actually, fixing the specific occurrences in WaypointDashboard.jsx:
